...
const features = [
  ...
  },
  {
    ...
    title: "Specialized Pharmacy",
  },
];

export default function WhatWeDo() {
  return (
    <section className="relative pt-32 pb-16 bg-[#fff7ed] overflow-hidden">
      {/* Decorative Shape */}
      <div className="absolute left-0 top-0 w-32 md:w-48 opacity-30 z-0">
        <img src="/images/shapes/shape-1.svg" alt="" className="w-full" />
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 justify-center">
          {features.map((feature, idx) => (
            <div key={idx} className="flex flex-col items-center">
              <div className="rounded-full p-5 mb-4 shadow-lg flex items-center justify-center">
              ...
              <h5 className="text-lg font-semibold text-[#ec821e] mt-2 text-center">
                {feature.title}
              </h5>
            </div>
          ))}
